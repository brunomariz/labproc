...
do_irq_interrupt: @ Rotina de interrupções IRQ
    ...
    CMP r10, #0                         @ verificacao se nproc eh 0 ou 1
    ...
    STRNE r0, linhaB                    @ se nproc for 1, fazemos a mesma coisa, mas agora com a pilha linhaB
    ADRNE r0, linhaB
    ...
    CMP r10, #0                         @ verificamos se nproc eh 0(A) ou 1(B)


    LDREQ r0, =linhaA                   @ se nproc for igual a 0, carregamos o endereco de linhaA em r0
    LDRNE r0, =linhaB                   @ caso contrario, carregamos linhaB
...
timer_irq: 
    ...
    MOVNE r10, #0                       @ se o task atual for 1, trocamos o nproc para 0
